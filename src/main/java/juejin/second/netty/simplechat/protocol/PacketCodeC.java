package juejin.second.netty.simplechat.protocol;
...
import juejin.second.netty.simplechat.serialize.impl.JSONSerializer;

import java.util.HashMap;
import java.util.Map;

import static juejin.second.netty.simplechat.protocol.command.Command.*;
